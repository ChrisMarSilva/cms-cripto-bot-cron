...
cryptocompare_api_key = '<crypto-compareapi-key>'
...
def gerar_msg_alerta_cripto(df) -> str:
...
def enviar_msg_alerta_cripto(chat_text: str ) -> str:
    try:
        ...
        print(f'Falha Geral - enviar_msg_alerta_cripto: {str(e)}')
...
def processar():
    try:
        ...
        enviar_msg_alerta_cripto(chat_text=chat_text)
    except Exception as e:
...
# heroku ps:scale clock=0 --app=cms-cripto-bot
